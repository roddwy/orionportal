  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navigation-fm">
      <ul class="nav navbar-nav">
        ...
        <li class="linavbar"><a href="{{route('infoempresa')}}">Nosotros <span class="glyphicon glyphicon-user" aria-hidden="true"></span></a></li>
        <li class="linavbar"><a href="{{route('contacto')}}">Contacto <span class="glyphicon glyphicon-phone" aria-hidden="true"></span></a></li>
      </ul>
    </div>
  </div>  
</nav>
