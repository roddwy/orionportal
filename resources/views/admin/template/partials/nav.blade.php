  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="{{ route('admin.typeproperties.index') }}">Tipo de propiedad<span class="sr-only">(current)</span></a></li>
        ...
        <li class="active"><a href="{{ route('admin.ownercurrents.index') }}">Propietarios</a></li>
        <li class="dropdown">
